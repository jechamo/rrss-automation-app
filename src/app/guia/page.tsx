...
const FLOWS: Flow[] = [
  ...
  },
  {
    ...
    steps: ["Pulsa + Contenido propio.", "Analiza funciones con IA y elige una.", "Revisa URL, pasos humanos y JSON de pasos automáticos.", "Pulsa Probar pasos: valida navegación sin grabar ni gastar vídeo generativo.", "Selecciona Automática y configura login si hace falta.", "Elige fal.ai o HeyGen.", "Con fal.ai, pulsa Preparar guion y prompts, edita los cortes B-roll y después Aprobar prompts y generar.", "Con HeyGen no hay prompts fal.ai: aprueba el plan directamente.", "Playwright emula iPhone, navega y guarda screen.mp4/nav_log.", "El montaje intercala hook, demo y cierre; luego quema subtítulos."],
  ...
  },
  {
    ...
    steps: ["Abre Estudio multimedia desde el menú del proyecto.", "Elige una pieza destino y pulsa Preparar automáticamente, o añade recursos desde la bandeja.", "Comprueba la comparación Vídeo/Locución. Las grabaciones Playwright aparecen divididas por pasos y protegidas.", "Selecciona un bloque para previsualizarlo y ajustar Entrada/Salida. Desbloquéalo solo si aceptas alterar ese momento.", "Arrastra o usa ↑/↓ para intercalar demostración y B-roll; elimina los cortes que no aporten.", "Si las duraciones difieren, pulsa Ajustar a locución: solo modifica bloques no protegidos.", "Comprueba la bandeja: cualquier clip generado pero sin utilizar queda señalado.", "Añade música opcional y ajusta su volumen.", "Pega la locución exacta en Subtítulos obligatorios; permanece en la zona segura inferior.", "Pulsa MIX cuando la diferencia sea como máximo 0,25 s.", "Reproduce la nueva versión. Solo entonces pulsa Usar como final."],
